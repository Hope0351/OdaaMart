...
import 'package:odaamart/common/widgets/code_picker_widget.dart';
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            prefixIcon: (widget.isPhone || widget.countryDialCode != null) ? SizedBox(width: 95, child: Row(children: [
              ...
              child: CustomAssetImageWidget(widget.prefixImage!, height: 10, width: 10, fit: BoxFit.cover, color: widget.focusNode?.hasFocus == true ? Theme.of(context).disabledColor : Theme.of(context).hintColor.withValues(alpha: 0.7)),
            ) : widget.prefixImage == null && widget.prefixIcon != null ? Icon(widget.prefixIcon, size: widget.iconSize, color: widget.focusNode?.hasFocus == true ? Theme.of(context).disabledColor : Theme.of(context).hintColor.withValues(alpha: 0.7)) : null,
