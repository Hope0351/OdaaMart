...
import 'package:odaamart/common/widgets/card_design/store_card.dart';
                                  ...
                                  return OnHover(
                                    ...
                                    child: isPharmacy ? StoreCard(store: storeList[index]) : InkWell(
                                      ...
                                      onTap: () {
                                        ...
                                        Get.toNamed(
                                          RouteHelper.getStoreRoute(id: storeList[index].id, page: 'store_new', slug: storeList[index].slug??''),
