    ...
    return Container(
      ...
      child: TextHover(
        builder: (hovered) {
          return InkWell(
            onTap: (){
              Get.toNamed(RouteHelper.getStoreRoute(id: advertisement.storeId, page: 'store_new', slug: 'store_${advertisement.storeId}'),
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  InkWell(
                    onTap: (){
                      Get.toNamed(RouteHelper.getStoreRoute(id: widget.advertisement.storeId, page: 'store_new', slug: ''),
