...
class ItemService implements ItemServiceInterface {
  ...
  Future<ItemReviewModel?> getItemReviews({
    ...
    return await itemRepositoryInterface.getItemReviews(
      itemId: itemId,
      limit: limit,
      offset: offset,
    );
  ...
  @override
  Future<List<CommonConditionModel>?> getCommonConditions({DataSourceEnum source = DataSourceEnum.client}) async {
    return await itemRepositoryInterface.getList(isCommonConditions: true, source: source);
  }

  @override
  Future<List<Item>?> getConditionsWiseItems(int id, {DataSourceEnum source = DataSourceEnum.client}) async {
    return await itemRepositoryInterface.get(id.toString(), isConditionWiseItem: true, source: source);
  }
