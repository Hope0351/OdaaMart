...
import 'package:odaamart/features/wallet/widgets/bonus_banner_widget.dart';
import 'package:odaamart/features/wallet/widgets/fund_status_dialog_widget.dart';
...
import 'package:odaamart/features/wallet/widgets/wallet_card_widget.dart';
import 'package:odaamart/features/wallet/widgets/wallet_history_widget.dart';
import 'package:odaamart/features/wallet/widgets/web_bonus_banner_widget.dart';
    ...
    if(AuthHelper.isLoggedIn()){
      ...
      if((widget.fundStatus == 'success' || widget.fundStatus == 'fail' || widget.fundStatus == 'cancel') && Get.find<WalletController>().getWalletAccessToken() != widget.token){
        Future.delayed(const Duration(seconds: 2), () {
          if(mounted) {
            showAnimatedDialog(context, FundStatusDialogWidget(isSuccess: widget.fundStatus == 'success'), dismissible: true);
          }
        }).then((value) {
