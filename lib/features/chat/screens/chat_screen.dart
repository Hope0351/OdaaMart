...
import 'package:odaamart/common/widgets/hover/text_hover.dart';
...
import 'package:odaamart/features/order/widgets/support_reason_bottom_sheet.dart';
...
import 'package:odaamart/features/chat/widgets/message_bubble_widget.dart';
      ...
      return PopScope(
        ...
        child: Scaffold(
          ...
          appBar: (ResponsiveHelper.isDesktop(context) ? const WebMenuBar() : AppBar(
            ...
            title: Text(
              chatController.messageModel?.conversation?.receiver != null ? '${chatController.messageModel!.conversation!.receiver!.fName} ${chatController.messageModel!.conversation!.receiver!.lName}' : (widget.notificationBody?.name ?? 'receiver_name'.tr),
                                ...
                                ResponsiveHelper.isDesktop(context) ? Container(
                                  ...
                                  child: Row(children: [
                                    ...
                                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      chatController.messageModel?.conversation?.receiver != null ? Text(
