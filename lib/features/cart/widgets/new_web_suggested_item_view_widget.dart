...
class NewWebSuggestedItemViewWidget extends StatefulWidget {
  final List<CartModel> cartList;
  const NewWebSuggestedItemViewWidget({super.key, required this.cartList});

  @override
  State<NewWebSuggestedItemViewWidget> createState() => _NewWebSuggestedItemViewWidgetState();
}

class _NewWebSuggestedItemViewWidgetState extends State<NewWebSuggestedItemViewWidget> {
