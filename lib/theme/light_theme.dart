...
ThemeData light({Color color = const Color(0xFF2D5016)}) => ThemeData(
  fontFamily: AppConstants.fontFamily,
  primaryColor: color,
  secondaryHeaderColor: const Color(0xFF4A7C23),
  ...
  colorScheme: ColorScheme.light(primary: color, secondary: color).copyWith(
      surface: const Color(0xFFFAF8F0)).copyWith(error: const Color(0xFFCC4433),
